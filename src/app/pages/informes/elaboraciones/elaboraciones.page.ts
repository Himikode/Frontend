...
@Component({
  selector: 'andromeda-elaboraciones',
  styleUrls: ['./elaboraciones.page.scss'],
  templateUrl: './elaboraciones.page.html',
})
export class ElaboracionesPage implements OnDestroy, OnInit {
